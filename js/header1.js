    ...
    document.querySelector('#page_body').insertAdjacentHTML('beforebegin', `
        <header>
            ...
            <ul id="menu">
                ...
                <li class="menus audiowide-regular" id="servicos"><a href="./pages/servicos.html">Serviços</a></li>
                <li class="menus audiowide-regular" id="educacao"><a href="./pages/educacao.html">Formação</a></li>
            </ul>
        </header> 
    `)
})